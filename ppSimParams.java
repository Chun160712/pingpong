 ...
 *  All parameters are taken from the instruction except for the addition of 
 *  the HighestEnergy parameter.
 *  
 * @author chun1
 *
 */
...
/***************************************************************************************
*    Title: Assignment 4 - An implementation of the Game of Pong
*    Author: Professor Frank Ferrie
*    
***************************************************************************************/
...
// 2. Parameters defined in simulation coordinates (MKS, x-->range, y-->height)
	...
	static final double HighestEnergy = 0.03;
